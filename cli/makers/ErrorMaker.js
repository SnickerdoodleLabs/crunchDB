...
var ErrorMaker = /** @class */ (function () {
    ...
    ErrorMaker.prototype.hasError = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    ErrorMaker.prototype.errorCodePath = function (name) {
        return this.errorDirectory + "errorCodes" + '.ts';
    };
    ErrorMaker.prototype.errorIndexPaht = function (name) {
    ...
    ErrorMaker.prototype.addErrorType = function (name) {
        ...
        console.log(content);
        return FileUtils_1.FileUtils.writeFile(this.errorCodePath(name), content).then(function (res) {
            if (res) {
                return _this.addToIndex(_this.errorDirectory + 'index.ts', "./".concat(name));
            }
            else {
                return false;
            }
    ...
    ErrorMaker.prototype.addToIndex = function (indexPath, classRelativePath) {
        // check if the class exists in the index file
        return FileUtils_1.FileUtils.readFile(indexPath).then(function (content) {
            if (content.includes(classRelativePath)) {
                return Promise.resolve(true);
            }
            else {
                content += "export * from '".concat(classRelativePath, "';\n");
                return FileUtils_1.FileUtils.writeFile(indexPath, content);
            }
        });
    };
