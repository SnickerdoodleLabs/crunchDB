...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_float_norm')) {
        Object.defineProperty(Module['ready'], '_float_norm', { configurable: true, get: function() { abort('You are getting _float_norm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_float_norm', { configurable: true, set: function() { abort('You are setting _float_norm on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_float_matrix_matrix_add')) {
        Object.defineProperty(Module['ready'], '_float_matrix_matrix_add', { configurable: true, get: function() { abort('You are getting _float_matrix_matrix_add on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_float_matrix_matrix_add', { configurable: true, set: function() { abort('You are setting _float_matrix_matrix_add on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
